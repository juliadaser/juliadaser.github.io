...
function list_of_countries() {
    ...
    let filtered;
    if (val === '') {
        filtered = suggestions.slice(0, 40); // show only the first 40 suggestions if there is no input
    } else {
...
function mouseClicked() {
    ...
    if (mouseX > 10 && mouseX < 70 && mouseY < windowHeight - 10 && mouseY > windowHeight - 80) {
